layui.use(['form','layer','table','laytpl','upload'],function(){
    ...
    var tableIns = table.render({
        ...
        url : '/system/robot/getRobotZFCList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
        ...
        cols : [[
            ...
            {field: 'scenicSpotName', title: '目前所在景区', minWidth:100, align:"center"},
    ...
    $('#downloadExcel').click(function(){
        window.resources("ROBOT_ARCHIVES_ZGCLL", function (e) {
            if (e.state == "200") {
                downloadExcel();
            } else {
                layer.msg(e.msg, {icon: 5,time: 1000,shift: 6});
    ...
    function downloadExcel(){
        ...
        window.location.href = "/system/robot/uploadExcelArchivesRobotZFGC?robotCode=" + robotCodeVal +"&scenicSpotId="+scenicSpotId;
    }

layui.use(['form','layer','table'],function(){
    ...
    var tableIns = table.render({
        ...
        url : '/system/sysRobotGpsDispatchLog/getRobotGpsDispatchList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
        ...
        cols : [[
            ...
            {field: 'exceedingTime', title: '超出时间', minWidth:100, align:"center"},
            {field: 'reason', title: '原因', minWidth:100, align:"center"},

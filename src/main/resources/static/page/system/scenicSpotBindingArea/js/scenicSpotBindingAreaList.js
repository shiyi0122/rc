layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            {field: 'scenicSpotPname', title: '景区归属省名称', minWidth:100, align:"center"},
            {field: 'scenicSpotSname', title: '景区归属市名称', minWidth:100, align:"center"},
            {field: 'scenicSpotFname', title: '景区归属区名称', minWidth:100, align:"center"},
    ...
    function openAddScenicSpotBinding(edit) {
        layer.open({
            ...
            offset: '10%',
            area: ['800px', '350px'],
            content: '/page/system/scenicSpotBindingArea/html/scenicSpotBindingAreaAdd.html',
    ...
    function openEditScenicSpotBinding(edit){
        ...
        setTimeout(function(){
            layer.open({
                ...
                offset: '10%',
                area: ['800px', '350px'],
                content: '/page/system/scenicSpotBindingArea/html/scenicSpotBindingAreaEdit.html',
                tableId: '#scenicSpotBindingList',
                success : function(layero, index){
                    ...
                    if(edit){
                        ...
                        // body.find(".scenicSpotPid").val(edit.scenicSpotPid);
                        body.find(".scenicSpotFname").val(edit.scenicSpotFname);
                        body.find(".scenicSpotSname").val(edit.scenicSpotSname);
                        body.find(".scenicSpotType").val(edit.scenicSpotType);
                        body.find(".scenicSpotPidN").val(edit.scenicSpotPid);
                        body.find(".scenicSpotSidN").val(edit.scenicSpotSid);

layui.use(['form','layer','jquery','upload'],function(){
    ...
    form.on('submit(btnAddImageForm)', function(data){
        ...
        $.ajax({
            url: "/system/broadcast/addBroadcastContentExtendImage",
            data: formData,
            type: "POST",
            async: true,
            cache:false,
    ...
    form.on('submit(btnAddVideoForm)', function(data){
        ...
        var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
        $.ajax({
            url: "/system/broadcast/addBroadcastContentExtendVideo",
            data: formData,
            type: "POST",
            async: true,
            cache:false,
    ...
    form.on('submit(btnAddAudioForm)', function(data){
        ...
        var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
        $.ajax({
            url: "/system/broadcast/addBroadcastContentExtendAudio",
            data: formData,
            type: "POST",
            async: true,
            cache:false,

layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#parkingList',
        url : '/system/parking/getParkingCoordList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
        ...
        cols : [[
            ...
            {field: 'parkingName', title: '库房名称', minWidth:100, align:"center"},
            {field: 'parkingContent', title: '库房内容', minWidth:100, align:"center"},
    ...
    function openAddParking() {
        layer.open({
            ...
            offset: '10%',
            area: ['800px', '520px'], //宽高
            content: '/page/system/ParkingCoord/html/parkingCoordAdd.html',
            tableId: '#parkingList',
    ...
    function openEditParking(edit){
        ...
        setTimeout(function(){
            layer.open({
                ...
                offset: '10%',
                area: ['800px', '520px'], //宽高
                content: '/page/system/ParkingCoord/html/parkingCoordEdit.html',
                tableId: '#parkingList',
                success : function(layero, index){
                    var body = layui.layer.getChildFrame('body', index);
                    $.ajax({

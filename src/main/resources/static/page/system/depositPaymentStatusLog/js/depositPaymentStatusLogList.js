layui.use(['form','layer','table'],function(){
    ...
    var tableIns = table.render({
        elem: '#depositPaymentStatusLogList',
    ...
    $("#btnSearch").on("click",function(){
        table.reload("depositPaymentStatusLogListTable",{
            page: {
                curr: 1 //重新从第 1 页开始
            },
            where: {

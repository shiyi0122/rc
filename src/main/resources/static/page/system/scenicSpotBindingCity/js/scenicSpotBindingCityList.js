layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'scenicSpotFname', title: '景区归属市/区名称', minWidth:100, align:"center"},
    ...
    function openAddScenicSpotBinding(edit) {
        layer.open({
            ...
            offset: '10%',
            area: ['800px', '350px'],
            content: '/page/system/scenicSpotBindingCity/html/scenicSpotBindingCityAdd.html',
    ...
    function openEditScenicSpotBinding(edit){
        ...
        setTimeout(function(){
            layer.open({
                ...
                offset: '10%',
                area: ['800px', '350px'],
                content: '/page/system/scenicSpotBindingCity/html/scenicSpotBindingCityEdit.html',
                tableId: '#scenicSpotBindingList',
                success : function(layero, index){
                    ...
                    if(edit){
                        ...
                        body.find(".scenicSpotPid").get(0).setAttribute("data-value",edit.scenicSpotPid);

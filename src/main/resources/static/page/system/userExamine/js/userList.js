layui.use(['form','layer','table','laytpl','upload'],function(){
    ...
    var tableIns = table.render({
        elem: '#userList',
        url : '/system/user/getUserExamineList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
        ...
        cols : [[
            ...
            {field: 'examine', title: '审核状态', align:'center',templet:function(d){
                    if(d.examineState == "1"){
                        return "通过";
    ...
    function roleDetails(edit){
        ...
        setTimeout(function(){
            layer.open({
                ...
                offset: '10%',
                area: ['1000px', '580px'], //宽高
                content: '/page/system/userExamine/html/userRoleDetailsList.html',
                success : function(layero, index){
                    var body = layui.layer.getChildFrame('body', index);
                    if(edit){
                        top.layer.close(dex);

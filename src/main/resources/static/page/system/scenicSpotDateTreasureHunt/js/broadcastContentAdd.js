layui.use(['form','layer','jquery','upload'],function(){
    ...
    form.on('submit(btnAddImageForm)', function(data){
        ...
        $.ajax({
            url: "/system/treasureHunt/addBroadcastHuntContentExtendImage",
            data: formData,
            type: "POST",
            async: true,
            cache:false,
    ...
    form.on('submit(btnAddVideoForm)', function(data){
        ...
        var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
        $.ajax({
            url: "/system/treasureHunt/addBroadcastHuntContentExtendVideo",
            data: formData,
            type: "POST",
            async: true,
            cache:false,
    ...
    form.on('submit(btnAddAudioForm)', function(data){
        ...
        var index = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
        $.ajax({
            url: "/system/treasureHunt/addBroadcastHuntContentExtendAudio",
            data: formData,
            type: "POST",
            async: true,
            cache:false,

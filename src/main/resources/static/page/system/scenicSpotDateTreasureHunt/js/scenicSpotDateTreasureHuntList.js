layui.use(['form','layer','table','laytpl','upload'],function(){
    ...
    var tableIns = table.render({
        elem: '#treasureList',
        url : '/system/scenicSpotDateTreasureHunt/getDateTreasureHuntList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
        ...
        cols : [[
            ...
            // {field: 'randomTime',title: '所属时间' ,minWidth: 100,align: "center"},
    ...
    table.on('tool(treasureList)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
            window.resources("SYS_SCENIC_SPOT_DATE_TREASURE_HUNT", function (e) {
                if (e.state == "200") {
            ...
            window.resources("SYS_SCENIC_SPOT_DATE_TREASURE_HUNT", function (e) {
                if (e.state == "200"){
                    window.resourcedel("/system/scenicSpotDateTreasureHunt/delDateTreasureHunt", {treasureId : data.treasureId , scenicSpotId : data.scenicSpotId}, function (data) {}, false,"GET","treasureListTable");
                }else if (e.state == "400"){
                    layer.msg(e.msg, {icon: 5,time: 1000,shift: 6});
                }
            }, false,"GET");
    ...
    function openAddTreasure() {
        layer.open({
            ...
            offset: '10%',
            area: ['800px', '460px'],
            content: '/page/system/scenicSpotDateTreasureHunt/html/scenicSpotDateTreasureHuntAdd.html',
    ...
    function openEditTreasure(edit){
        ...
        setTimeout(function(){
            layer.open({
                ...
                offset: '10%',
                area: ['800px', '580px'],
                content: '/page/system/scenicSpotDateTreasureHunt/html/scenicSpotDateTreasureHuntEdit.html',
                ...
                success : function(layero, index){
                    var body = layui.layer.getChildFrame('body', index);
                                if(edit){
                                    ...
                                    // body.find(".randomTimes").val(edit.randomTime);

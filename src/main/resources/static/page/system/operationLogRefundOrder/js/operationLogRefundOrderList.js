layui.use(['form','layer','table'],function(){
    ...
    var tableIns = table.render({
        ...
        url : '/system/orderLog/getOperationLogRefundOrderList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
    ...
    function downloadExcel(){
        ...
        window.location.href = "/system/orderLog/uploadExcelOrderLog?orderLogPhone=" + orderLogPhone + "&startTime=" + startTime + "&endTime=" +endTime;
    }

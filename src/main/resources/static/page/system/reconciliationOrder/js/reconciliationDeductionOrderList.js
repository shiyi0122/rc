layui.use(['form','layer','table'],function(){
    ...
    var tableIns = table.render({
        elem: '#reconciliationStoredOrderList',
        ...
        id : "reconciliationStoredOrderListTable",
		where : {
			subMethod : "3"
		},
        cols : [[
            ...
            {field: 'deductibleAmount', title: '抵扣金额', minWidth:100, align:"center"},
    ...
    $("#btnSearch").on("click",function(){
        table.reload("reconciliationStoredOrderListTable",{
            page: {
                curr: 1 //重新从第 1 页开始
            },
            where: {
    ...
    $('#downloadExcel').click(function(){
        window.resources("RECONCILIATION_DEDUCTION_ORDER_DOWNLOAD", function (e) {
            if (e.state == "200") {
                downloadExcel();
            } else {
    ...
    function downloadExcel(){
        ...
        if (subMethod == ''){
            ...
            window.location.href = "/system/reconciliationOrder/uploadExcelReconciliationDeductionOrder?data="+data+"&subMethod="+subMethod;
        }

layui.use(['form','layer','table','laytpl','upload'],function(){
    ...
    var tableIns = table.render({
        elem: '#treasureList',
        url : '/system/treasureHuntRule/getTreasureHuntRuleNewList',
        cellMinWidth : 100,
        page : true,
        height : "full-125",
        request: {
        ...
        cols : [[
            ...
            {field: 'ruleContents', title: '开机播报规则内容', minWidth:100, align:"center"},
    ...
    function openAddTreasure() {
        layer.open({
            ...
            offset: '10%',
            area: ['800px', '460px'],
            content: '/page/system/treasureHuntRule/html/treasureRuleAdd.html',
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data.state == "200"){
                            ...
                            body.find(".ruleContents").val(data.data.ruleContents);
    ...
    function openEditTreasure(edit){
        ...
        setTimeout(function(){
            layer.open({
                ...
                offset: '10%',
                area: ['800px', '580px'],
                content: '/page/system/treasureHuntNewRule/html/treasureRuleEdit.html',
                ...
                success : function(layero, index){
                    var body = layui.layer.getChildFrame('body', index);
                                if(edit){
                                    ...
                                    body.find(".ruleContents").val(edit.ruleContents);
                                    form.render();
                                }
                }
            });

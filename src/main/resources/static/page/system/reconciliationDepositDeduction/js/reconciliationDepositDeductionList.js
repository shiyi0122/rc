layui.use(['form','layer','table'],function(){
    ...
    table.render({
        elem: '#reconciliationDepositDeductionList',
        ...
        id : "reconciliationDepositDeductionListTable",
		where : {
        	subMethod : "4"
		},
        cols : [[
    ...
    $("#btnSearch").on("click",function(){
        table.reload("reconciliationDepositDeductionListTable",{
            page: {
                curr: 1 //重新从第 1 页开始
            },
            where: {
    ...
    $('#downloadExcel').click(function(){
        window.resources("RECONCILIATION_DEPOSIT_DEDUCTION_DOWNLOAD", function (e) {
            if (e.state == "200") {
                downloadExcel();
            } else {

layui.config({
    ...
    $('#expandAll').click(function () {
        treetable.expandAll('#resList');
    });

    $('#foldAll').click(function () {
        treetable.foldAll('#resList');
    });
    ...
    function openAddMenu() {
        layer.open({
            ...
            offset: '10%',
            area: ['800px', '80%'],
            content: '/page/system/resource/html/resourceAdd.html',
            tableId: '#resList'
        });
    };

(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['exports', 'echarts4'], factory);
    } else if (typeof exports === 'object' && typeof exports.nodeName !== 'string') {
        // CommonJS
        factory(exports, require('echarts4'));
    } else {
        // Browser globals
        factory({}, root.echarts4);
    }
}(this, function (exports, echarts4) {
    ...
    if (!echarts4) {
        log('echarts4 is not Loaded');
        return;
    }
    if (!echarts4.registerMap) {
        log('echarts4 Map is not loaded')
        return;
    }
    echarts4.registerMap('china', {

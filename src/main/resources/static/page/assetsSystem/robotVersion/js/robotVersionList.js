layui.use(['form','layer','table','laytpl','upload'],function(){
    ...
    table.render({
        ...
        cols : [[
            ...
            {field: 'masterControlFirmwareVersion', title: '主控固件版本号', minWidth:100, align:"center"},
            {field: 'rangingModularVersion', title: '避障模块版本号', minWidth:100, align:"center"},
            {field: 'updateDate', title: '添加时间', minWidth:100, align:"center"},
    ...
    $("#btnSearch").on("click",function(){
        ...
        table.reload("robotBelarcAdvisorListTable",{
            ...
            url: '/system/robotVersion/getRobotVersionsAll',
            where: {
                robotCode: $(".robotCodeVal").val(),  //搜索的关键字
                scenicSpotId: $(".scenicSpotId").val(),  //搜索的关键字
                // robotCodeSim : $(".robotCodeSimVal").val(),
                masterControlFirmwareVersion: $(".masterControlFirmwareVersion").val(),
                rangingModularVersion: $(".rangingModularVersion").val()
            }
        })
    });

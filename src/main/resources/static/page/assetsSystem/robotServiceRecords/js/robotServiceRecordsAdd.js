layui.use(['form','layer','jquery','upload'],function(){
    ...
    //     window.resource("/system/robotErrorRecords/addRobotErrorRecords", data.field, function (data) {}, false,"POST",'robotPartsManagementListTable');
    //     return false;
    // });
    ...
    form.on('submit(btnSubmitPartsManagement)', function(data){
        ...
        $.ajax({
            url: "/system/robotServiceRecords/addRobotServiceRecords",
            data: formData,
            type: "POST",
            async: true,
            cache: false,
            ...
            success: function (e) {
                if (e.state == "200") {
                    setTimeout(function(){
                        ...
                        parent.layui.table.reload('robotErrorRecordsListTable');
                    },500);
                } else {
                    setTimeout(function(){
                        top.layer.close(index);

layui.use(['form','layer','jquery','upload','layedit'],function(){
    ...
    //监听提交
    form.on('submit(btnSubmitScenicSpotExpand)', function(data){
        window.resource("/business/scenicSpotExpand/editScenicSpotExpand", data.field, function (data) {}, false,"POST",'scenicSpotExpandListTable');
        return false;
    });

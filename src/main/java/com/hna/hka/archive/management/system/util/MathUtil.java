...
public class MathUtil {
     ...
     * 汉字
     */
    public static String[] CN_CHARS = new String[] { "零", "壹", "贰", "叄", "肆",
            "伍", "陆", "柒", "捌", "玖" };
    ...
    public static String positiveNumberChangeNegative(long num) {

        if (num <= 0){
            return null;
        }else {
            long numNegative =  num - 2*num ;
            return String.valueOf(numNegative);
        }
    ...
    public static void main(String[] args) {
        System.out.println(MathUtil.cvt(12345 , false));
    }
}

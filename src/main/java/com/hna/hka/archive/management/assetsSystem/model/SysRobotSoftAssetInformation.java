...
//    private String cost;
    ...
    @Excel(name = "当天运行时间",width = 10,orderNum = "16")
    @ApiModelProperty("当天运行时间")
    private Integer dayTime;
    @Excel(name = "当月运行时间",width = 10,orderNum = "17")
    @ApiModelProperty("当月运行时间")
    private Integer monthTime;
    @Excel(name = "当年运行时间",width = 10,orderNum = "18")
    @ApiModelProperty("当年运行时间")
    private Integer yearTime;
    //运行时长
    @Excel(name = "总运行时长",width = 10,orderNum = "19")
